...
VoiceProxy.prototype.sendSMS = function(conversation) {
  ...
  this.nexmo.message.sendSms(conversation.userB.virtualNumber.msisdn,
                             ...
                             'Call this number to talk to UserB ' + conversation.userB.virtualNumber.msisdn + '  ');
  ...
  this.nexmo.message.sendSms(conversation.userA.virtualNumber.msisdn,
                             ...
                             'Call this number to talk to UserA ' +conversation.userA.virtualNumber.msisdn) + ' ';
...
console.error("fromUserA" + fromUserA);
console.error("fromUserB" + fromUserB);
